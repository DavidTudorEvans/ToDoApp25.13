                         // SETTING UP DEPENDENCIES install in the app.  INDEX.JS  is the backend server file
require("dotenv").config(); // Loads env variable into server
const express = require("express"); //loads "node_modules" toolbox from NPM (Node Package Manager - terminal command line "npm install express"). It enables the use of Express.js (express is for backend JS like Bootstrap is for HTML.)
const cors = require("cors"); //--Enables cross origin resource sharing (opens the boom gate between the frontend and backend)
...
//------------------DATABASE CONNECTION AND APP START UP  --------------------------------------------------------
...
// Type of data structure to be used in the database 
const Task = mongoose.model("Task", taskSchema);  //Task with a capital T is interacting with the database

//------------------API ROUTES BETWEEN FRONTEND AND BACKEND-------------------------------------------------------

// Get all tasks ready for the request from the front end line 56 in api.js. This backend address is "localhost:3000" 
...
//Edit the task and update the details
